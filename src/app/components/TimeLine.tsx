...
import JaleebiStore from "../../../public/JaleebiStore.png"
import hz4jobsHome from "../../../public/hz4jobsHome.png"
import Hz4jobsTab from "../../../public/Hz4jobsTab.png"
import WhyChooseHz4jobs from "../../../public/WhyChooseHz4jobs.png"
import BuycexProfileTab from "../../../public/BuycexProfileTab.png"
import BuycexExpress from "../../../public/BuycexExpress.png"
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Deployed 5 Big Projects for international Clients
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Buycex a cryptocurrency site
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ SafeDeposit Website
            </div>
